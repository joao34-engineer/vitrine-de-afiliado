...
function row(overrides: Partial<SupabaseProductRow> = {}): SupabaseProductRow {
  return {
    ...
    classification_suggested_department_slug: null,
    classification_suggested_subcategory_slug: null,
    classification_suggested_leaf_slug: null,
    classification_reasons: ["text-strong-match"],
    classification_revision: 0,
    classification_updated_at: "2026-08-12T00:00:00.000Z",
