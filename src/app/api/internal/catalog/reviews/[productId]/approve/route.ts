...
import { approveAffiliateReviewRequestSchema } from "@/features/classification-review/model/affiliate-review-requests";
...
export async function POST(
  ...
  try {
    ...
    const payload = approveAffiliateReviewRequestSchema.parse(body);
    const result = await approveClassificationReview(params.productId, payload.leafSlug, payload.expectedRevision, payload.operationId);
