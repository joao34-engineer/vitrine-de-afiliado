...
values
  ...
  ('36179f98-9abb-4692-a203-4fa2c8339367'::uuid, 'mais', 'automotivo', 'achadinhos-gerais', 'legacy-backfill-v1', 0.85, 'auto'),
  ...
  ('83d5b62c-d798-4401-97b6-4421e2619503'::uuid, 'cozinha', 'eletroportateis', 'eletroportateis', 'legacy-backfill-v1', 0.88, 'auto'),
  ...
  ('f5f27e0d-91ae-48ef-873f-0867f9f5fac2'::uuid, 'homens', 'roupas', 'roupas-masculinas', 'legacy-backfill-v1', 0.88, 'auto'),
  ('6171a9c8-5fed-4f38-9343-94782f7a2c42'::uuid, 'mulheres', 'roupas', 'roupas-femininas', 'legacy-backfill-v1', 0.95, 'auto'),
  ('a57cd548-acce-41fd-9f21-09686fd3d1f9'::uuid, 'homens', 'roupas', 'roupas-masculinas', 'legacy-backfill-v1', 0.88, 'auto'),
  ...
  ('5bec0f2c-92e6-499a-bb89-a8aea32789c7'::uuid, 'mulheres', 'roupas', 'roupas-femininas', 'legacy-backfill-v1', 0.85, 'auto'),
  ...
  ('ac293fce-f2f8-4571-91d0-43c6f05c7628'::uuid, 'tech', 'audio', 'eletronicos', 'legacy-backfill-v1', 0.85, 'auto'),
  ...
  ('650ea0d3-a7ce-4b93-9058-fbc489dfea0d'::uuid, 'cozinha', 'utensilios', 'utensilios-de-cozinha', 'legacy-backfill-v1', 0.85, 'auto'),
  ...
  ('18bdb95c-677d-4ac4-a66d-6c6ac4a1ab84'::uuid, 'mais', 'automotivo', 'automotivo', 'legacy-backfill-v1', 0.85, 'auto'),
